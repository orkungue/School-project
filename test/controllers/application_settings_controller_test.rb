...
class ApplicationSettingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create application_setting" do
    assert_difference('ApplicationSetting.count') do
      post application_settings_url, params: { application_setting: { setup: @application_setting.setup } }
    end
  ...
  test "should update application_setting" do
    patch application_setting_url(@application_setting), params: { application_setting: { setup: @application_setting.setup } }
