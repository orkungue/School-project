...
class DocsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create doc" do
    assert_difference('Doc.count') do
      post docs_url, params: { doc: { doc_content: @doc.doc_content, doc_headline: @doc.doc_headline, doc_type: @doc.doc_type, user_id: @doc.user_id } }
    end
  ...
  test "should update doc" do
    patch doc_url(@doc), params: { doc: { doc_content: @doc.doc_content, doc_headline: @doc.doc_headline, doc_type: @doc.doc_type, user_id: @doc.user_id } }
