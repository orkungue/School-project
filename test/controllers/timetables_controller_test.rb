...
class TimetablesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create timetable" do
    assert_difference('Timetable.count') do
      post timetables_url, params: { timetable: { class_id: @timetable.class_id, timetable_content: @timetable.timetable_content } }
    end
  ...
  test "should update timetable" do
    patch timetable_url(@timetable), params: { timetable: { class_id: @timetable.class_id, timetable_content: @timetable.timetable_content } }
